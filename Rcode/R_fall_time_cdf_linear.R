...
falltime_linear_model1 = read.csv("07. linear_model1 fall time 10.67m_1clips.csv", header = TRUE)
falltime_linear_model2 = read.csv("00. linear_model2 fall time 10.67m_2clips.csv", header = TRUE)
falltime_linear_model3 = read.csv("01. linear_model3 fall time 6.82m_1clips.csv", header = TRUE)
falltime_linear_model4 = read.csv("02. linear_model4 fall time 6.82m_2clips.csv", header = TRUE)
p1 <- as.numeric(unlist(falltime_linear_model1))
p2 <- as.numeric(unlist(falltime_linear_model2))
p3 <- as.numeric(unlist(falltime_linear_model3))
p4 <- as.numeric(unlist(falltime_linear_model4))

title1 = "predicted fall time cdf"
df <- data.frame(x = c(p1), ggg=factor(rep(1:1, c(3999))))
